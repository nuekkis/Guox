...
exports.buildFastifyAdapter = buildFastifyAdapter;
class FastifyAdapter {
    ...
    preHandlerHook() {
        return (req, reply, done) => {
            ...
            this.guox
                .run(adapterReq, adapterRes, done)
                .then((outcome) => {
                ...
                .catch((e) => {
                try {
                    (req.log ?? { error: (_) => undefined }).error(e);
                }
                catch {
                    /* ignore */
                }
...
function buildFastifyAdapter(guox, opts) {
